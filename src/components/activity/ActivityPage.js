  ...
  <SkeletonWrapper>
    {Array.from({ length: count }).map((_, index) => (
      <SkeletonGroup key={index}>
        <Skeleton width="40%" height={20} style={{ marginBlockEnd: 8 }} />
        <Skeleton width="80%" height={20} style={{ marginBlockEnd: 8 }} />
        <Skeleton width="55%" height={20} style={{ marginBlockEnd: 8 }} />
