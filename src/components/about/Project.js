    ...
    <PageTemplate>
      <div className="grid">
        ...
        <p>
          <em>
            ...
            invite you to join us on Phrase, where our translations are managed.
          </em>
        </p>
        ...
        <p>
          ...
          reconnect with the botanical origins of food. Our edible map is not
          the first of its kind, but it aspires to be the world's most
          comprehensive. While our users contribute locations of their own, we
          comb the internet for pre-existing knowledge, seeking to unite the
          efforts of foragers, foresters, and freegans everywhere. The imported
          datasets range from small neighborhood foraging maps to vast
          professionally-compiled tree inventories. This so far amounts to 2,959
          different types of edibles (most, but not all, plant species)
          distributed over 1,478,212 locations. Beyond the cultivated and
          commonplace to the exotic flavors of foreign plants and long-forgotten
          native plants, foraging in your neighborhood is a journey through time
          and across cultures. Join us in celebrating hyper-local food! The map
          is open for anyone to edit, the database can be downloaded with just
          one click, and the{' '}
          ...
          humans. Our sharing page lists hundreds of local organizations -
          planting public orchards and food forests, picking otherwise-wasted
          fruits and vegetables from city trees and farmers' fields, and sharing
          with neighbors and the needy.
        </p>
      </div>
      <h2>Staff</h2>
      <div className="content">
        ...
        <p>
          ...
          <br />
          Zürich, Switzerland With technology and data, Ethan champions cities
          as sources of fresh and free food. He created Falling Fruit with Caleb
          Phillips in 2013 to promote urban foraging worldwide, and co-founded
      ...
      <div className="content">
        ...
        <p>
          ...
          <br />
          Boulder, Colorado, USA Since harvesting black and blueberries with his
          family as a child and, more recently, noticing the wealth of public
          fruit trees throughout Colorado, Jeff has developed a deep
          appreciation for the abundance of fruit growing in our cities. His
          first mission for Falling Fruit was to comb Boulder and Salt Lake
          City, paper maps in-hand, to record fruiting trees. When not working
          to improve building energy efficiency, he is usually helping out in
          the community or moving quickly over mountains by foot, ski, or
          bicycle.
        </p>
      </div>
      <div className="content">
        ...
        <p>
          <b>Craig Durkin</b>
          <br />
          Atlanta, Georgia, USA Craig is the co-founder of
      ...
      <div className="content">
        ...
        <p>
          <b>Emily Sigman</b>
          <br />
          New Haven, Connecticut, USA Emily is a diehard agroforestry
          evangelist, incorrigible forager, and proud mother to two cats, four
          quails, and the world's most magnificent canine. Her roots stretch
          deep into the Rocky Mountains, but these days her aboveground biomass
          is proud to call New Haven, Connecticut her home. She can often be
          found tending public food forests, reading enraptured in some cozy
          library corner, or waxing poetic about the magic of mycelium (and,
          supposedly, completing joint graduate degrees at the Yale
      ...
      <div className="content">
        ...
        <p>
          <b>Alan Gibson</b>
          <br />
          Southampton, United Kingdom Alan has always enjoyed adventures and
          exploring. He began foraging as a way to introduce his young children
          to the outdoors lifestyle. He writes the{' '}
      ...
      <div className="content">
        ...
        <p>
          ...
          <br />
          Silver City, New Mexico, USA Ana is a postdoctoral researcher at the
          Federal University of Pará in Brazil. She is an anthropologist
          interested in understanding social and cultural diet habits. Ana
          worked mostly in the Brazilian Amazon. In Acre (western Amazon) she
          studied regional fruit consumption. Then, she worked in the Middle
          Solimões region, investigating diet change in remote communities.
          Between 2017 and 2018, Ana lived in small and medium towns of the
          Amazon Delta, looking at the effects of climate change on the food
          security of people living in informal settlements. She recently moved
          to southern New Mexico in the United States, where she works as a
          consultant.
        </p>
      </div>
      <div className="content">
        ...
        <p>
          <b>Caleb Phillips</b>
          <br />
          Boulder, Colorado, USA Caleb is a featherless bipedal humanoid
          passionate about food justice and finding creative ways to use
          technology to address social issues. When he's not biking around
          gawking at trees, he balances his efforts between his day job as a
      ...
      <div className="content">
        ...
        <p>
          <b>Cristina Rubke</b>
          <br />
          San Francisco, California, USA Cristina is an attorney with{' '}
      ...
      <div className="content">
        ...
        <p>
          <b>David Craft</b>
          <br />
          Cambridge, Massachusetts, USA David is a researcher in the Department
      ...
      <div className="content">
        ...
        <p>
          <b>Tristram Stuart</b>
          <br />
          United Kingdom As a teenager, Tristram raised pigs on surplus food
          that he collected from his school kitchens, the local baker and
          village greengrocer. Noticing that a lot of this food was still
          suitable for human consumption led him to the realization that good,
          fresh food was being wasted on a colossal scale. Tristram has since
          worked tirelessly to bring this issue to the attention of the public,
          the media, and policy-makers. He founded the food waste campaign
          organization{' '}
      ...
      <div className="content">
        <p>
          ...
          foraging, we recommend the following summary. Information on Falling
          Fruit may be wrong or out of date. For example, many of the foraging
          maps migrated to Falling Fruit were hosted as public Google Maps on
          which markers were often moved accidentally, and municipal tree
          inventories are updated only (if ever) as trees are visited for
          maintenance. Be prepared to encounter inaccuracies in the field, and
          please edit the map as needed based on your discoveries. Ultimately,
          it is your responsibility to determine the identity, edibility, and
          location of a plant, and the responsibility of all to improve the
          quality of the map.
        </p>
        <img
          className="logo"
          src="https://fallingfruit.org/bycolorado.svg"
          alt=""
        />
      </div>
    </PageTemplate>
